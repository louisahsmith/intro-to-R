...
# Exercises 2
.center[
<iframe src="https://giphy.com/embed/TvVck7lO4LDJS" width="288" height="216" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/TvVck7lO4LDJS"></a></p>
]
...
<br><br>https://ggplot2.tidyverse.org/reference/scale_gradient.html
...
# Exercises 4
.center[
<iframe src="https://giphy.com/embed/xT9IgFQsNYi1zBUiyc" width="200" height="200" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/pixel-sweet-drink-xT9IgFQsNYi1zBUiyc"></a></p>
]
...
```{r theme6, fig.show = "hide", eval = FALSE}
ggplot(data = nlsy) +
  geom_boxplot(aes(
    x = factor(sleep_wknd), 
    y = sleep_wkdy,
