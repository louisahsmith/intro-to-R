...
- Which value would someone with `sleep_wknd = 8` and `sleep_wknd = 4` go? 
- What about someone with  `sleep_wknd = 11` and `sleep_wknd = 4`? 
- What about someone with `sleep_wknd = 7` and `sleep_wknd = 7`?
...
nlsy <- mutate(nlsy, slp_cat_wkdy_ord = `fct_relevel`(slp_cat_wkdy,
...
nlsy <- mutate(nlsy, slp_cat_wkdy_ord2 = fct_relevel(slp_cat_wkdy,
...
```{r eval = FALSE, echo = FALSE}
exer4.1 <- filter(nlsy, (sleep_wkdy > 7 & sleep_wknd > 7) |
                    (income >= 20000 & income <= 50000))
exer4.2 <- filter(nlsy, is.na(slp_cat_wkdy))
nrow(exer4.2)
exer4.3 <- filter(nlsy, (sleep_wkdy > 7 & sleep_wknd > 7) |
